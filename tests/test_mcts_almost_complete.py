#!/usr/bin/env python3
"""
Test MCTS starting from an almost-complete circuit (2 moves away).
See if MCTS can learn to complete it within 50000 iterations.
"""
    ...
    for i in range(1, max_iterations + 1):
        ...
        if i % 1000 == 0:
            ...
            if final_board.is_complete_and_valid():
                ...
                # Save to file
                with open('/tmp/mcts_circuit_output.txt', 'w') as f:
